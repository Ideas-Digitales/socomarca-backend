...
return [
    ...
    */
    'attributes' => [
        ...
        'amount' => 'cantidad',
        'answer' => 'respuesta',
        'auth_code' => 'código autenticación',
        'brand_id' => 'id marca',
        ...
        'favorite_list_id' => 'id lista favoritos',
        ...
        'price' => 'precio',
        'price_id' => 'id precio',
        'price_list_id' => 'id lista precios',
        'product_id' => 'id producto',
        'quantity' => 'cantidad',
        'question' => 'pregunta',
        'random_product_id' => 'id producto aleatorio',
        'region_id' => 'id región',
        'response_message' => 'mensaje respuesta',
        'response_status' => 'estado respuesta',
        'rut' => 'rut',
        'sku' => 'sku',
        'status' => 'estado',
        'stock' => 'stock',
